...
static unsigned int get_phy_version(struct phy *phy)
{
	...
	u3phy_write_reg8(i2c_port_base,
			 A60931_I2C_ADDR, 0xff, PHY_VERSION_BANK);

	version = u3phy_read_reg32(i2c_port_base,
			A60931_I2C_ADDR, PHY_VERSION_ADDR);
	dev_info(u3phy->dev,
		 "ssusb phy version: %x %pa\n",
...
static int a60931_init(struct phy *phy)
{
	...
	MTK_FPGA_DBG("[U2P]addr: 0xFF, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0xFF));
	MTK_FPGA_DBG("[U2P]addr: 0x00, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x00));
	MTK_FPGA_DBG("[U2P]addr: 0x05, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x05));
	MTK_FPGA_DBG("[U2P]addr: 0x18, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x18));
	MTK_FPGA_DBG("[U2P]addr: 0x1d, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x1d));
	MTK_FPGA_DBG("[U2P]addr: 0x6A, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x6A));
	MTK_FPGA_DBG("[U2P]addr: 0x68, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x68));
	MTK_FPGA_DBG("[U2P]addr: 0x6C, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x6C));
	MTK_FPGA_DBG("[U2P]addr: 0x6D, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x6D));
	MTK_FPGA_DBG("*********** after ***********\n");
	/* u3phy_write_reg8(i2c_port_base, 0x60, 
			   u3phy_read_reg8(i2c_port_base, 0x60, 0x0) | 0x20, 0x00);*/ /* INTR_EN */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x05, 0x55); /* U2PHYACR1: TERM, VRT */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x15, 0x40); /* SLEW RATE */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x18, 0x84); /* U2PHYACR6: SQTH, DISCTH */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x1a, 0x00); /* disable BC11 */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x6A, 0x04); /* U2PHYDTM0,1: force suspendm */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x68, 0x08);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x6C, 0x26); /* force iddig, avalid, sessend, vbusvalid */
	u3phy_write_reg8(i2c_port_base, 0x60, 0x6D, 0x36);
	...
	MTK_FPGA_DBG("[U2P]addr: 0x0A, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x0A));
	MTK_FPGA_DBG("*********** after ***********\n");

	u3phy_write_reg8(i2c_port_base, 0x60, 0x0A, 0x84);
	...
	MTK_FPGA_DBG("[U2P]addr: 0x38, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x38));
	MTK_FPGA_DBG("[U2P]addr: 0x42, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x42));
	MTK_FPGA_DBG("[U2P]addr: 0x08, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x08));
	MTK_FPGA_DBG("[U2P]addr: 0x09, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x09));
	MTK_FPGA_DBG("[U2P]addr: 0x0C, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x0C));
	MTK_FPGA_DBG("[U2P]addr: 0x0E, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x0E));
	MTK_FPGA_DBG("[U2P]addr: 0x10, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x10));
	MTK_FPGA_DBG("[U2P]addr: 0x14, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x14));
	MTK_FPGA_DBG("*********** after ***********\n");

	u3phy_write_reg8(i2c_port_base, 0x60, 0x38, 0x46);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x42, 0x40);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x08, 0xAB);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x09, 0x0C);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x0C, 0x71);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x0E, 0x4F);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x10, 0xE1);
	u3phy_write_reg8(i2c_port_base, 0x60, 0x14, 0x5F);
	MTK_FPGA_DBG("[U2P]addr: 0xFF, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0xFF));
	MTK_FPGA_DBG("[U2P]addr: 0x38, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x38));
	...
	u3phy_write_reg8(i2c_port_base, 0x60, 0xFF, 0x60);
	MTK_FPGA_DBG("[U2P]addr: 0xFF, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0xFF));
	MTK_FPGA_DBG("[U2P]addr: 0x10, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x14));
	...
	u3phy_write_reg8(i2c_port_base, 0x60, 0x14, 0x03);
	MTK_FPGA_DBG("[U2P]addr: 0xFF, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0xFF));
	MTK_FPGA_DBG("[U2P]addr: 0x10, value: %x\n",
		u3phy_read_reg8(i2c_port_base, 0x60, 0x14));
...
#ifdef NEVER_USE
static int a60931_u3phy_change_pclk_phase(void __iomem *i2c_port_base,
						 unsigned int pclk_phase)
{
	u3phy_write_reg8(i2c_port_base, 0x70, 0xff, 0x70);
...
/* for OTG test */
static int a60931_u3phy_u2_reg_w(void __iomem *i2c_port_base,
						u8 addr, u8 data)
{
...
static const struct of_device_id a60931_u3phy_id_table[] = {
	{
	 .compatible = "mediatek,a60931-u3phy",
	 .data = &a60931_pdata
	},
	{ },
};
...
static int u3phy_fpga_a60931_probe(struct platform_device *pdev)
{
	...
	for_each_child_of_node(np, child_np) {
		...
		dev_info(dev,
			 "devm_ioremap_resource: Port%i_io %pa\n", port,
			  instance->port_base);
