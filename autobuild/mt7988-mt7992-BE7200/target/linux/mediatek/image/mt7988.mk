...
define Device/mediatek_mt7988d-dsa-10g-msi-1pcie-spim-nand
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988d-dsa-10g-msi-1pcie-spim-nand
  DEVICE_DTS := mt7988d-dsa-10g-msi-1pcie-spim-nand
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988d-dsa-10g-msi-1pcie-spim-snand
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988d-dsa-10g-msi-1pcie-spim-nand

define Device/mediatek_mt7988d-dsa-10g-msi-2pcie-spim-nand
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := mt7988d-dsa-10g-msi-2pcie-spim-nand
  DEVICE_DTS := mt7988d-dsa-10g-msi-2pcie-spim-nand
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := mediatek,mt7988d-dsa-10g-msi-2pcie-spim-snand
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += mediatek_mt7988d-dsa-10g-msi-2pcie-spim-nand
