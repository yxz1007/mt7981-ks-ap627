...
if [ "$release" = '1' ]; then
	...
	# Remove mtk internal patches and follow gateway/WiFi7/mac80211/backport source folder
	WIFI7_IW_SOURCE_DIR=${BUILD_DIR}/package/network/utils/iw/src; rm -rf ${WIFI7_IW_SOURCE_DIR};
	git clone -q ${BUILD_DIR}/./../mac80211_package/wifi7_iw_src ${WIFI7_IW_SOURCE_DIR}
	cd ${WIFI7_IW_SOURCE_DIR}; git remote add gerrit https://gerrit.mediatek.inc/gateway/WiFi7/mac80211/iw; git fetch gerrit --unshallow; cd -;
	mv ${WIFI7_IW_SOURCE_DIR}/../patches ${WIFI7_IW_SOURCE_DIR}/../patches_bak
fi
