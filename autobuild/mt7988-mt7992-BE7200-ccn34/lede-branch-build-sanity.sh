...
MT7990_CCN34_BDIR=${BUILD_DIR}/./autobuild/mt7988-mt7990-BE19000-ccn34
...
cp -fpR ${MT7990_CCN34_BDIR}/target/linux/mediatek/patches-5.4/999-48*.patch ${BUILD_DIR}/autobuild/${branch_name}/target/linux/mediatek/patches-5.4/
cp -fpR ${MT7990_CCN34_BDIR}/target/linux/mediatek/base-files/sbin/iwpriv_29 ${BUILD_DIR}/autobuild/${branch_name}/target/linux/mediatek/base-files/sbin/
cp -fpR ${MT7990_CCN34_BDIR}/.custom.config ${BUILD_DIR}/autobuild/${branch_name}/

# End of Copy Jaguar+Eagle and ccn34 package, target and tools temporarily
