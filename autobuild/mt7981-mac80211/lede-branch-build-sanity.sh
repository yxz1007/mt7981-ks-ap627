...
cp -rf ${FW_SOURCE_DIR}/firmware/mt7981/rebb/7981_WACPU_RAM_CODE_release.bin ${FW_SOURCE_DIR}/src/firmware/mt7981_wa.bin
cp -rf ${FW_SOURCE_DIR}/firmware/mt7981/rebb/WIFI_RAM_CODE_MT7981.bin ${FW_SOURCE_DIR}/src/firmware/mt7981_wm.bin
cp -rf ${FW_SOURCE_DIR}/firmware/mt7981/rebb/mt7981_patch_e1_hdr.bin ${FW_SOURCE_DIR}/src/firmware/mt7981_rom_patch.bin
cp -rf ${FW_SOURCE_DIR}/firmware/mt7981/rebb/7981_WOCPU0_RAM_CODE_release.bin ${FW_SOURCE_DIR}/src/firmware/mt7981_wo.bin
