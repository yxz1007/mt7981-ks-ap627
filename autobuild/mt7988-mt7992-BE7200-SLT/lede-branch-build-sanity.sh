...
import_branch_name=mt7988-mt7992-BE7200
...
#		sed -i 's/CONFIG_PACKAGE_kmod-ufsd_driver=y/# CONFIG_PACKAGE_kmod-ufsd_driver is not set/g' ${BUILD_DIR}/.config
	...
	[ "$twopcie" = "1" ] && {
		echo "2pcie"
		sed -i 's/CONFIG_MTK_HWIFI_MT799A=n/CONFIG_MTK_HWIFI_MT799A=y/g' ${BUILD_DIR}/.config
		...
		sed -i 's/# CONFIG_PACKAGE_kmod-mt799a is not set/CONFIG_PACKAGE_kmod-mt799a=y/g' ${BUILD_DIR}/.config
	}
